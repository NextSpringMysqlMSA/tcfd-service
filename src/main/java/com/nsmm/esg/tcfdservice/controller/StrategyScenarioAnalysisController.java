...
import com.nsmm.esg.tcfdservice.service.StrategyScenarioAnalysisService;
...
public class StrategyScenarioAnalysisController {

    private final StrategyScenarioAnalysisService strategyScenarioAnalysisService;
    ...
    public List<StrategyScenarioAnalysisRequest> getScenarios(HttpServletRequest httpRequest) {
        ...
        return strategyScenarioAnalysisService.getScenarios(memberId);
    }
    //----------------------------------------------------------------------------------------------------------------
    ...
    public String createScenario(@RequestBody StrategyScenarioAnalysisRequest request,
        ...
        Long memberId = extractMemberId(httpRequest);
        Long id = strategyScenarioAnalysisService.createScenario(memberId, request);
    ...
    public String updateScenario(@PathVariable Long id,
                                 ...
                                 HttpServletRequest httpRequest) {
        Long memberId = extractMemberId(httpRequest);
        strategyScenarioAnalysisService.updateScenario(memberId, id, request);
    ...
    public String deleteScenario(@PathVariable Long id,
                                 HttpServletRequest httpRequest) {
        Long memberId = extractMemberId(httpRequest);
        strategyScenarioAnalysisService.deleteScenario(memberId, id);
